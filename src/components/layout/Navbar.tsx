        ...
        <nav className="fixed top-0 left-0 right-0 z-40 bg-background/60 backdrop-blur-xl border-b border-primary/10 shadow-sm animate-slide-down">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden lg:flex items-center gap-8">
                        <button onClick={() => handleNavClick('heroRef')} className="text-foreground/80 hover:text-primary transition-colors font-semibold nav-link font-heading active:scale-90">Home</button>
                        <button onClick={() => handleNavClick('servicesRef')} className="text-foreground/80 hover:text-primary transition-colors font-semibold nav-link font-heading active:scale-90">Serviços</button>
                        <button onClick={() => handleNavClick('aboutRef')} className="text-foreground/80 hover:text-primary transition-colors font-semibold nav-link font-heading active:scale-90">Quem Somos</button>
                        <button onClick={() => handleNavClick('processRef')} className="text-foreground/80 hover:text-primary transition-colors font-semibold nav-link font-heading active:scale-90">Como Funciona</button>
                        <button onClick={() => handleNavClick('testimonialsRef')} className="text-foreground/80 hover:text-primary transition-colors font-semibold nav-link font-heading active:scale-90">Depoimentos</button>
                    </div>
            ...
            <div className={`lg:hidden fixed inset-x-0 top-20 bg-background/95 backdrop-blur-xl border-b border-primary/10 overflow-hidden transition-all duration-500 ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="p-6 flex flex-col gap-4">
                    <button onClick={() => handleNavClick('heroRef')} className="text-left text-lg font-bold font-heading py-2 border-b border-primary/5 active:translate-x-2 transition-transform">Home</button>
                    <button onClick={() => handleNavClick('servicesRef')} className="text-left text-lg font-bold font-heading py-2 border-b border-primary/5 active:translate-x-2 transition-transform">Serviços</button>
                    <button onClick={() => handleNavClick('aboutRef')} className="text-left text-lg font-bold font-heading py-2 border-b border-primary/5 active:translate-x-2 transition-transform">Quem Somos</button>
                    <button onClick={() => handleNavClick('processRef')} className="text-left text-lg font-bold font-heading py-2 border-b border-primary/5 active:translate-x-2 transition-transform">Como Funciona</button>
                    <button onClick={() => handleNavClick('testimonialsRef')} className="text-left text-lg font-bold font-heading py-2 active:translate-x-2 transition-transform">Depoimentos</button>
                </div>
            </div>
        </nav>
    );
